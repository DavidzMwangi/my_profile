        ...
        <div class="page-sidebar  sidebar-nav">
            ...
            <ul id="menu" class="page-sidebar-menu">
                ...
                <li>
                    ...
                    <ul class="sub-menu">
                        <li>
                            <a href="{{url('backend/new_project')}}">
                                <i class="fa fa-angle-double-right"></i>
                                New Project
                            </a>
                        </li>
                        <li>
                            <a href="{{url('backend/view_projects')}}">
                                <i class="fa fa-angle-double-right"></i>
                                View All Projects
                            </a>
                        </li>
                        <li>
                            <a href="{{url('backend/add_project_pic')}}">
                                <i class="fa fa-angle-double-right"></i>
